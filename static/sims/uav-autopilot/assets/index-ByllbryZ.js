...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(e,t,n){let r=new Float32Array(Ra),i=new G(0,1,0);return new Ti({name:`SphericalGaussianBlur`,defines:{n:Ra,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:to(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new Ti({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:to(),fragmentShader:`
	...
	`}var no=class extends Et{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=bs(i,i.VERTEX_SHADER,y),S=bs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Es(i,x,`vertex`),n=Es(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,fragmentShader:`
      ...
      void main() {
        float h = vDir.z;
        vec3 col = mix(horizon, zenith, smoothstep(0.0, 0.62, h));
        col = mix(ground, col, smoothstep(-0.12, 0.03, h));
        gl_FragColor = vec4(col, 1.0);
      }
    `}),t=new kr(new gi(4200,40,24),e);return t.frustumCulled=!1,t}function Bl(){let e=new hi(Ol,Ol,kl,kl),t=e.attributes.position,n=new Float32Array(t.count*3),r=new Y(9078400),i=new Y(7038304),a=new Y(4021306),o=new Y(5081662),s=new Y(6988618),c=new Y(9418058),l=new Y(12890970),u=new Y(8022594),d=new Y(6054248),f=new Y(5935944);for(let e=0;e<t.count;e+=1){let n=Nl(t.getX(e),t.getY(e));t.setZ(e,n)}e.computeVertexNormals();let p=e.attributes.normal;for(let e=0;e<t.count;e+=1){let m=t.getX(e),h=t.getY(e),g=t.getZ(e),_=p.getZ(e),v=1-Math.max(0,_),y=Pl(m,h),b=Fl(m,h),x=Ll(m,h),S;if(x>.5)S=d;else if(y>.45)S=Rl(o,d,y);else if(g>28||v>.28)S=Rl(a,Rl(r,i,v),Ml(20,90,g)+v);else if(b>.4)S=Rl(s,f,b);else{let e=Q(Math.floor(m/72),Math.floor(h/72));S=e<.22?l:e<.4?u:e<.7?s:c,S=Rl(S,o,.15+.2*jl(m*.02,h*.02,2))}n[e*3]=S.r,n[e*3+1]=S.g,n[e*3+2]=S.b}return e.setAttribute(`color`,new Gn(n,3)),new kr(e,new Di({vertexColors:!0}))}function Vl(t,n,r){let i=document.createElement(`canvas`);i.width=t,i.height=n,r(i.getContext(`2d`),t,n);let a=new si(i);return a.colorSpace=Ie,a.wrapS=e,a.wrapT=e,a.anisotropy=4,a}function Hl(){return Vl(64,256,(e,t,n)=>{e.fillStyle=`#2c3540`,e.fillRect(0,0,t,n);for(let r=6;r<n-4;r+=7)for(let n=3;n<t-3;n+=6)e.fillStyle=Q(n,r)>.38?Q(n+3,r)>.7?`#ffe08a`:`#8ec6e8`:`#1a222b`,e.fillRect(n,r,3.2,4.2)})}function Ul(e,t,n,r,i,a,o,s=0){let c=new di(i,a,o);c.rotateZ(s),c.translate(t,n,r),e.push(c)}function Wl(e,t,n,r,i,a=Math.min(r,i)){let o=r>=i,s=(o?r:i)/2,c=o?t:n,l=o?n:t;for(let t=c-s+18;t<c+s;t+=36){let n=o?t:l,r=o?l:t,i=Nl(n,r);o?Ul(e,n,r,i+.38,38.4,a,.48,0):Ul(e,n,r,i+.38,a,38.4,.48,0)}}function Gl(){let e=[];Wl(e,400,180,2200,16,16),Wl(e,400,920,2200,16,16),Wl(e,140,700,16,2800,16);for(let t=-200;t<=320;t+=48)Wl(e,t,860,6.5,2100,6.5);for(let t=-160;t<=1920;t+=48)Wl(e,60,t,600,6.5,6.5);for(let t=500;t<=1080;t+=64)Wl(e,t,820,11,1680,11);for(let t=40;t<=1600;t+=64)Wl(e,790,t,700,11,11);Wl(e,-80,-420,9,520,9),Wl(e,-180,-560,420,8,8);let t=e,n=[],r=[],i=[],a=0;for(let e of t){let t=e.attributes.position,o=e.attributes.normal;for(let e=0;e<t.count;e+=1)n.push(t.getX(e),t.getY(e),t.getZ(e)),r.push(o.getX(e),o.getY(e),o.getZ(e));let s=e.index;if(s)for(let e=0;e<s.count;e+=1)i.push(s.getX(e)+a);a+=t.count,e.dispose()}let o=new or;return o.setAttribute(`position`,new Jn(n,3)),o.setAttribute(`normal`,new Jn(r,3)),o.setIndex(i),new kr(o,new Di({color:3816770,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2}))}function Kl(e,t,n,r,i,a,o,s,c,l){let u=new J,d=new st().setFromAxisAngle(new G(0,0,1),c);u.compose(new G(n,r,i),d,new G(a,o,s)),e.setMatrixAt(t,u),l&&e.setColorAt(t,l)}function ql(){let e=new Vr(new di(1,1,1),new Di({color:16777215}),720);e.instanceColor=new Nr(new Float32Array(2160),3);let t=new Vr(new mi(.72,1,4),new Di({color:16777215,flatShading:!0}),720);t.instanceColor=new Nr(new Float32Array(2160),3);let n=new st().setFromAxisAngle(new G(1,0,0),Math.PI/2),r=[15259844,13217946,14673130,12174504,15390640,13808780].map(e=>new Y(e)),i=[11817786,4937056,7027242,4152634].map(e=>new Y(e)),a=0,o=(o,s,c,l=1)=>{if(a>=720||Pl(o,s)>.35)return;let u=Nl(o,s);if(u>18)return;let d=(13+Q(a,3)*7)*l,f=(10+Q(a,4)*6)*l,p=(5.2+Q(a,5)*3.2)*l;Kl(e,a,o,s,u+p/2,d,f,p,c,r[a%r.length]);let m=new J,h=new st().setFromAxisAngle(new G(0,0,1),c+Math.PI/4).multiply(n);m.compose(new G(o,s,u+p+1.4*l),h,new G(d*1.05,2.8*l,f*1.05)),t.setMatrixAt(a,m),t.setColorAt(a,i[a%i.length]),a+=1};for(let e=-4;e<=6;e+=1)for(let t=-3;t<=40;t+=1){let n=e*48+16+(Q(e,t)-.5)*10,r=t*48+16+(Q(t,e+9)-.5)*10;Math.abs(n-140)<16||Q(e,t)<.12||o(n,r,(Q(e+2,t)>.5?0:Math.PI/2)+(Q(e,t)-.5)*.12)}for(let e=0;e<90&&a<720;e+=1)o(-80+Q(e,21)*240-520,-180-Q(e,22)*800,Q(e,23)*Math.PI*2,1.2);return e.count=a,t.count=a,e.instanceMatrix.needsUpdate=!0,t.instanceMatrix.needsUpdate=!0,e.instanceColor.needsUpdate=!0,t.instanceColor.needsUpdate=!0,[e,t]}function Jl(){let e=new Vr(new di(1,1,1),new Di({map:Hl(),color:16777215}),220);e.instanceColor=new Nr(new Float32Array(660),3);let t=[12175058,10135477,14009505,9085112,13620958].map(e=>new Y(e)),n=0;for(let r=0;r<10;r+=1)for(let i=0;i<24&&!(n>=220);i+=1){if(Q(r,i)<.1)continue;let a=500+r*64+(Q(r,i+4)-.5)*12,o=40+i*64+(Q(i,r+7)-.5)*12,s=Nl(a,o),c=18+Q(r+11,i)*20,l=Q(r,i+30)<.18?120+Q(r,i)*60:38+Q(r,i+31)*55;Kl(e,n,a,o,s+l/2,c,c*(.75+Q(i,r)*.4),l,0,t[n%t.length]),n+=1}return e.count=n,e.instanceMatrix.needsUpdate=!0,e.instanceColor.needsUpdate=!0,e.material.map.repeat.set(1,4),e}function Yl(){let e=new Vr(new pi(.28,.4,1,5),new Di({color:5914672}),900),t=new Vr(new mi(1,1,6),new Di({color:4160056,flatShading:!0}),900),n=new st().setFromAxisAngle(new G(1,0,0),Math.PI/2),r=0,i=(i,a,o)=>{if(r>=900||Pl(i,a)>.2)return;let s=Nl(i,a);if(s>95)return;let c=new J;c.compose(new G(i,a,s+1.4*o),n,new G(o,2.8*o,o)),e.setMatrixAt(r,c);let l=new J;l.compose(new G(i,a,s+4.2*o),n,new G(2.4*o,5.2*o,2.4*o)),t.setMatrixAt(r,l),r+=1};for(let e=0;e<380;e+=1){let t=-160-Q(e,1)*1200,n=-1e3+Q(e,2)*3200;Nl(t,n)<6||i(t,n,1.1+Q(e,3)*1.4)}for(let e=0;e<220;e+=1)i(-520+Q(e,8)*980,-1e3+Q(e,9)*900,1+Q(e,10)*1.1);for(let e=-4;e<=6;e+=1)for(let t=-3;t<=40;t+=1)Q(e+40,t)<.62||i(e*48+30,t*48-18,1.05);return e.count=r,t.count=r,e.instanceMatrix.needsUpdate=!0,t.instanceMatrix.needsUpdate=!0,[e,t]}function Xl(){let e=-620,t=new kr(new fi(160,40),new Di({color:3832997,transparent:!0,opacity:.92,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1}));return t.position.set(-40,e,Nl(-40,e)+.35),t}function Zl(){return[{pts:[[-500,186],[1300,186]],speed:16},{pts:[[-500,174],[1300,174]],speed:15},{pts:[[-500,926],[1300,926]],speed:16},{pts:[[132,-1e3],[132,2100]],speed:17},{pts:[[148,2100],[148,-1e3]],speed:16},{pts:[[520,80],[1060,80],[1060,1580],[520,1580]],closed:!0,speed:13},{pts:[[-180,-120],[-180,1880],[300,1880],[300,-120]],closed:!0,speed:12}]}function Ql(e){let t=e.closed?[...e.pts,e.pts[0]]:e.pts,n=0;for(let e=0;e<t.length-1;e+=1)n+=Math.hypot(t[e+1][0]-t[e][0],t[e+1][1]-t[e][1]);return{pts:t,len:n}}function $l(e,t){let n=(t%e.len+e.len)%e.len;for(let t=0;t<e.pts.length-1;t+=1){let r=e.pts[t],i=e.pts[t+1],a=Math.hypot(i[0]-r[0],i[1]-r[1]);if(n<=a){let e=a<1e-6?0:n/a;return{x:r[0]+(i[0]-r[0])*e,y:r[1]+(i[1]-r[1])*e,heading:Math.atan2(i[0]-r[0],i[1]-r[1])}}n-=a}let r=e.pts[e.pts.length-1];return{x:r[0],y:r[1],heading:0}}function eu(){let e=new Vr(new di(1.8,4.2,1.3),new Di({color:16777215}),48);e.instanceColor=new Nr(new Float32Array(144),3);let t=[12597547,15528177,2899536,2719929,15844367,2600544,9323693].map(e=>new Y(e)),n=Zl().map(e=>({...e,...Ql(e)})),r=[];for(let i=0;i<48;i+=1){let a=n[i%n.length];r.push({path:a,s:i/48*a.len,speed:a.speed*(.85+Q(i,50)*.3)}),e.setColorAt(i,t[i%t.length])}return e.instanceColor.needsUpdate=!0,{mesh:e,cars:r}}function tu(e,t){let n=new tn;n.up.set(0,0,1);for(let r=0;r<e.cars.length;r+=1){let i=e.cars[r];i.s+=i.speed*t;let a=$l(i.path,i.s);n.position.set(a.x,a.y,Nl(a.x,a.y)+.85),n.rotation.set(0,0,-a.heading),n.updateMatrix(),e.mesh.setMatrixAt(r,n.matrix)}e.mesh.instanceMatrix.needsUpdate=!0}function nu(e){e.background=new Y(8894169),e.fog=new dn(11126749,420,3200),e.add(new Gi(13625087,7047754,.85));let t=new oa(16774096,1.15);t.position.set(420,-280,620),e.add(t);let n=new nn,r=zl(),i=Bl(),a=Gl(),o=ql(),s=Jl(),c=Yl(),l=Xl(),u=eu();return e.add(r),n.add(i,a,l,s,u.mesh,...o,...c),{group:n,update(e,t){r.position.copy(t.position),tu(u,e)}}}var ru=1100;function iu(e,t,n,r,i,a,o){return{x:i+(e-n)*o,y:a-(t-r)*o}}function au(e,t,n,r,i,a,o){e.beginPath(),t.forEach(([t,s],c)=>{let l=iu(t,s,n,r,i,a,o);c===0?e.moveTo(l.x,l.y):e.lineTo(l.x,l.y)}),e.closePath(),e.fill()}function ou(e,t){let n=[];function r(){let t=Math.min(window.devicePixelRatio||1,2),n=e.clientWidth||176;e.width=Math.round(n*t),e.height=Math.round(n*t)}function i(){n.length=0}function a(r){if(e.clientWidth<40)return;let[i,a]=r.x,o=r.chi,s=r.cmd.chi,c=e.width,l=e.height,u=c/2,d=l/2,f=Math.min(c,l)/2-2,p=f/ru,m=e.getContext(`2d`);n.push([a,i]),n.length>220&&n.shift(),m.clearRect(0,0,c,l),m.save(),m.beginPath(),m.arc(u,d,f,0,Math.PI*2),m.clip(),m.fillStyle=`#1a2a18`,m.fillRect(0,0,c,l),m.fillStyle=`#3d5c3a`,au(m,[[-2200,-2200],[-80,-2200],[-80,2800],[-2200,2800]],a,i,u,d,p),m.fillStyle=`#4a7a3c`,au(m,[[-300,-280],[460,-280],[460,2200],[-300,2200]],a,i,u,d,p),m.fillStyle=`#4b525a`,au(m,[[380,-60],[1240,-60],[1240,1840],[380,1840]],a,i,u,d,p);let h=iu(-40,-620,a,i,u,d,p);m.fillStyle=`#2f6f96`,m.beginPath(),m.arc(h.x,h.y,160*p,0,Math.PI*2),m.fill(),m.strokeStyle=`#2a2d32`,m.lineWidth=Math.max(1.2,14*p),m.beginPath(),[[-700,180,1500,180],[-700,920,1500,920],[140,-700,140,2100]].forEach(([e,t,n,r])=>{let o=iu(e,t,a,i,u,d,p),s=iu(n,r,a,i,u,d,p);m.moveTo(o.x,o.y),m.lineTo(s.x,s.y)}),m.stroke(),n.length>1&&(m.strokeStyle=`rgba(125, 211, 252, 0.7)`,m.lineWidth=Math.max(1.5,c*.012),m.beginPath(),n.forEach(([e,t],n)=>{let r=iu(e,t,a,i,u,d,p);n===0?m.moveTo(r.x,r.y):m.lineTo(r.x,r.y)}),m.stroke()),m.strokeStyle=`rgba(226, 232, 240, 0.16)`,m.lineWidth=1;for(let e=1;e<=2;e+=1)m.beginPath(),m.arc(u,d,f*e/2,0,Math.PI*2),m.stroke();m.save(),m.translate(u,d),m.rotate(s),m.strokeStyle=`rgba(34, 211, 238, 0.9)`,m.setLineDash([6,5]),m.lineWidth=1.6,m.beginPath(),m.moveTo(0,8),m.lineTo(0,-f+10),m.stroke(),m.setLineDash([]),m.restore(),m.save(),m.translate(u,d),m.rotate(o),m.fillStyle=`#7dd3fc`,m.strokeStyle=`#0b1220`,m.lineWidth=1.4,m.beginPath(),m.moveTo(0,-11),m.lineTo(7.5,9),m.lineTo(0,5),m.lineTo(-7.5,9),m.closePath(),m.fill(),m.stroke(),m.restore(),m.restore(),m.strokeStyle=`rgba(148, 163, 184, 0.55)`,m.lineWidth=2,m.beginPath(),m.arc(u,d,f,0,Math.PI*2),m.stroke();let g=[[`N`,0,-1],[`E`,1,0],[`S`,0,1],[`W`,-1,0]];m.fillStyle=`#e2e8f0`,m.font=`${Math.round(c*.08)}px "IBM Plex Sans", sans-serif`,m.textAlign=`center`,m.textBaseline=`middle`;let _=f-c*.08;g.forEach(([e,t,n])=>{m.fillStyle=e===`N`?`#7dd3fc`:`#94a3b8`,m.fillText(e,u+t*_,d+n*_)}),t&&(t.textContent=`χ ${(o*180/Math.PI).toFixed(0)}° → ${(s*180/Math.PI).toFixed(0)}°`)}return r(),{draw:a,reset:i,resize:r}}function su(e){let t=e;for(;t>180;)t-=360;for(;t<-180;)t+=360;return t}function cu(e){let t=[`north`,`northeast`,`east`,`southeast`,`south`,`southwest`,`west`,`northwest`],n=(e%360+360)%360;return t[Math.round(n/45)%8]}function lu(e,t){return Math.hypot(t+40,e+620)<220?`the lake`:t>380&&t<1240&&e>-60&&e<1840?`downtown`:t>-300&&t<460&&e>-280&&e<2200?`the suburbs`:t<-200?`the western ridges`:e<-400?`the southern fields`:`the corridor`}function uu(e,t,n,r=800){return lu(e+Math.cos(n)*r,t+Math.sin(n)*r)}function du(e,t,n){let r=lu(e,t),i=uu(e,t,n);return r===i?`Over ${r}.`:`Over ${r}, heading for ${i}.`}function fu(e,t){if(!t)return`pause`;let[n,r]=e.x,i=e.cmd.h-e.h,a=su((e.cmd.chi-e.chi)*180/Math.PI),o=e.cmd.va-e.Va;return Math.abs(i)>14?i>0?`climb`:`descend`:Math.abs(a)>14?a>0?`right`:`left`:Math.abs(o)>2.2?o>0?`accel`:`decel`:`cruise:${lu(n,r)}:${uu(n,r,e.chi)}`}function pu(e,t,n){let[r,i]=e.x,a=e.chi*180/Math.PI,o=e.cmd.chi*180/Math.PI,s=su(o-a),c=du(r,i,e.chi);if(!t)return`${n} is holding. Loops are frozen until Start. ${c}`;let l=fu(e,t);if(l===`climb`)return`Climbing to ${Math.round(e.cmd.h)} m. Pitch loop has the elevator; throttle is pinned to hold ${Math.round(e.cmd.va)} m/s. ${c}`;if(l===`descend`)return`Descending to ${Math.round(e.cmd.h)} m. Altitude hold is commanding a shallower pitch. ${c}`;if(l===`right`)return`Right turn to ${cu(o)}, course ${Math.round(o)}°. Outer loop is asking for bank; ailerons still have about ${Math.abs(Math.round(s))}° of course to close. ${c}`;if(l===`left`)return`Left turn to ${cu(o)}, course ${Math.round(o)}°. Course hold is commanding roll; the inner loop is flying the ailerons. ${c}`;if(l===`accel`)return`Speeding up to ${Math.round(e.cmd.va)} m/s. Throttle is coming in so the pitch loop can keep altitude. ${c}`;if(l===`decel`)return`Slowing to ${Math.round(e.cmd.va)} m/s. Throttle back; elevator will trim so we do not sink. ${c}`;let u=[`Winds calm, visibility unlimited.`,`Still air. Nothing for the gust filters.`,`METAR 00000KT 10SM FEW040.`],d=u[Math.floor(e.t/28)%u.length];return`${n} in cruise at ${Math.round(e.h)} m, ${cu(a)}. Airspeed, altitude, and course loops are closed. ${d} ${c}`}var mu=[`Good morning. Cincinnati Departure — Unmanned Aerial Systems, Chapter 5 Autopilot. Welcome aboard.`,`Weather on the hour: winds calm, visibility ten miles, a few clouds at four thousand, eighteen degrees. Clean air for successive-loop closure.`,`Krishna One is cleared to cruise. I will call the loops — and the ground under her, and what she is turning toward.`];function hu(e){let t=``,n=0,r=0,i=0,a=``,o=34;function s(){t=``,n=0,r=0,i=0,a=``,e&&(e.textContent=``)}function c(e,i=34){t=e,n=0,r=4.2,o=i}function l(s,l,u,d){if(!e)return;t||(c(mu[0],28),i=1);let f=fu(s,u),p=n<t.length;!p&&r<=0?i<mu.length?(c(mu[i],28),i+=1):(c(pu(s,u,d),36),a=f):!p&&i>=mu.length&&f!==a&&(c(pu(s,u,d),38),a=f),n<t.length?n=Math.min(t.length,n+o*l):r-=l,e.textContent=t.slice(0,Math.floor(n))}return{update:l,reset:s}}var gu=il(),_u=document.querySelector(`#viewport`),vu=new Vc({canvas:_u,antialias:!0,logarithmicDepthBuffer:!0});vu.setPixelRatio(Math.min(window.devicePixelRatio,2));var yu=new fn;yu.up.set(0,0,1);var bu=new ra(55,1,2,5200);bu.up.set(0,0,1);var xu=nu(yu);yu.add(xu.group);var Su=Tl(`krishna`);yu.add(Su.root);var Cu=Dl();yu.add(Cu.object);var wu=new Set,Tu=28,Eu=40,Du=40,Ou=250,$={pause:document.querySelector(`#pause`),reset:document.querySelector(`#reset`),model:document.querySelector(`#model`),va:document.querySelector(`#va`),h:document.querySelector(`#h`),chi:document.querySelector(`#chi`),vaVal:document.querySelector(`#va-val`),hVal:document.querySelector(`#h-val`),chiVal:document.querySelector(`#chi-val`),hud:document.querySelector(`#hud`),hudToggle:document.querySelector(`#hud-toggle`),chapter:document.querySelector(`#chapter`),mT:document.querySelector(`#m-t`),mVa:document.querySelector(`#m-va`),mH:document.querySelector(`#m-h`),mChi:document.querySelector(`#m-chi`),mPhi:document.querySelector(`#m-phi`),mTheta:document.querySelector(`#m-theta`),mPsi:document.querySelector(`#m-psi`),mPos:document.querySelector(`#m-pos`),mDe:document.querySelector(`#m-de`),mDa:document.querySelector(`#m-da`),mDr:document.querySelector(`#m-dr`),mDt:document.querySelector(`#m-dt`),minimap:document.querySelector(`#minimap-canvas`),minimapChi:document.querySelector(`#minimap-chi`)},ku=ou($.minimap,$.minimapChi),Au=hu(document.querySelector(`#subtitle-text`));function ju(){$.vaVal.textContent=`${Number($.va.value).toFixed(0)} m/s`,$.hVal.textContent=`${Number($.h.value).toFixed(0)} m`,$.chiVal.textContent=`${Number($.chi.value).toFixed(0)}°`}function Mu(){return{va:Number($.va.value),h:Number($.h.value),chi:Number($.chi.value)*Math.PI/180}}function Nu(){ju(),gu.setCommand(Mu())}function Pu(){$.va.value=`35`,$.h.value=`100`,$.chi.value=`0`,ju()}function Fu(e){let t=e;for(;t>180;)t-=360;for(;t<-180;)t+=360;return t}function Iu(e){let t=wu.has(`ArrowUp`)||wu.has(`KeyW`),n=wu.has(`ArrowDown`)||wu.has(`KeyS`),r=wu.has(`ArrowLeft`)||wu.has(`KeyA`),i=wu.has(`ArrowRight`)||wu.has(`KeyD`);!t&&!n&&!r&&!i||(t&&($.h.value=String(Math.min(Ou,Number($.h.value)+Tu*e))),n&&($.h.value=String(Math.max(Du,Number($.h.value)-Tu*e))),r&&($.chi.value=String(Fu(Number($.chi.value)-Eu*e))),i&&($.chi.value=String(Fu(Number($.chi.value)+Eu*e))),Nu())}function Lu(e){return e.code?e.code:{w:`KeyW`,a:`KeyA`,s:`KeyS`,d:`KeyD`,W:`KeyW`,A:`KeyA`,S:`KeyS`,D:`KeyD`,ArrowUp:`ArrowUp`,ArrowDown:`ArrowDown`,ArrowLeft:`ArrowLeft`,ArrowRight:`ArrowRight`}[e.key]||``}function Ru(e){return e===`ArrowUp`||e===`ArrowDown`||e===`ArrowLeft`||e===`ArrowRight`||e===`KeyW`||e===`KeyA`||e===`KeyS`||e===`KeyD`}function zu(e){if(e===`ArrowUp`||e===`KeyW`)$.h.value=String(Math.min(Ou,Number($.h.value)+2));else if(e===`ArrowDown`||e===`KeyS`)$.h.value=String(Math.max(Du,Number($.h.value)-2));else if(e===`ArrowLeft`||e===`KeyA`)$.chi.value=String(Fu(Number($.chi.value)-3));else if(e===`ArrowRight`||e===`KeyD`)$.chi.value=String(Fu(Number($.chi.value)+3));else return;Nu()}function Bu(e,t=1){return Number.isFinite(e)?e.toFixed(t):`—`}function Vu(e){return e*180/Math.PI}function Hu(e){return e>.004?`pos`:e<-.004?`neg`:``}function Uu(e,t,n){if(e.textContent=t,n===void 0){e.className=``;return}e.className=Hu(n)}function Wu(e){let[t,n,,,,,r,i,a]=e.x,[o,s,c,l]=e.delta,u=c+.45*s;Uu($.mT,`${Bu(e.t,1)} s`),Uu($.mVa,`${Bu(e.Va)} / ${Bu(e.cmd.va)} m/s`),Uu($.mH,`${Bu(e.h)} / ${Bu(e.cmd.h)} m`),Uu($.mChi,`${Bu(Vu(e.chi))} / ${Bu(Vu(e.cmd.chi))}°`),Uu($.mPhi,`${Bu(Vu(r))}°`,r),Uu($.mTheta,`${Bu(Vu(i))}°`,i),Uu($.mPsi,`${Bu(Vu(a))}°`),Uu($.mPos,`${Bu(t,0)}, ${Bu(n,0)} m`),Uu($.mDe,`${Bu(Vu(o))}°`,o),Uu($.mDa,`${Bu(Vu(s))}°`,s),Uu($.mDr,`${Bu(Vu(u))}°`,u),Uu($.mDt,Bu(l,2))}function Gu(){let{clientWidth:e,clientHeight:t}=_u;vu.setSize(e,t,!1),bu.aspect=e/Math.max(1,t),bu.updateProjectionMatrix(),ku.resize()}function Ku(e){let[t,n,r,,,,,,i]=e.x,a=xl(t,n,r),o=-Math.cos(i)*28+Math.sin(i)*12,s=-Math.sin(i)*28-Math.cos(i)*12;bu.position.set(a.x+s,a.y+o,a.z+10),bu.lookAt(a.x,a.y,a.z)}function qu(e,t=0){let[n,r,i,,,,a,o,s]=e.x;Cl(Su.root,n,r,i,a,o,s),Su.update(e,t),Cu.push(n,r,i),Ku(e),Wu(e),ku.draw(e),Au.update(e,t,gu.running,$.model.selectedOptions[0]?.text||`Krishna's UAV`)}function Ju(e){yu.remove(Su.root),El(Su),Su=Tl(e),yu.add(Su.root),qu(gu.getState())}$.va.addEventListener(`input`,Nu),$.h.addEventListener(`input`,Nu),$.chi.addEventListener(`input`,Nu),$.model.addEventListener(`change`,()=>Ju($.model.value)),$.hudToggle.addEventListener(`click`,()=>{let e=$.hud.classList.toggle(`collapsed`);$.hudToggle.textContent=e?`+`:`−`,$.hudToggle.title=e?`Expand flight data`:`Minimize flight data`,$.hudToggle.setAttribute(`aria-expanded`,String(!e))}),$.pause.addEventListener(`click`,()=>{let e=gu.toggleRunning();$.pause.textContent=e?`Pause`:`Start`}),$.reset.addEventListener(`click`,()=>{Cu.reset(),ku.reset(),Au.reset(),Pu();let e=gu.reset();$.pause.textContent=`Pause`,qu(e)}),window.addEventListener(`keydown`,e=>{if(e.target instanceof HTMLSelectElement&&(e.code===`ArrowUp`||e.code===`ArrowDown`))return;if(e.code===`Space`){e.preventDefault(),$.pause.click();return}let t=Lu(e);Ru(t)&&(e.preventDefault(),wu.add(t),e.repeat||zu(t))}),window.addEventListener(`keyup`,e=>{wu.delete(Lu(e))}),window.addEventListener(`blur`,()=>wu.clear()),window.addEventListener(`resize`,Gu),Nu(),Gu(),qu(gu.getState());var Yu=performance.now();function Xu(e){let t=(e-Yu)/1e3;Yu=e,Iu(t),qu(gu.advance(t),t),xu.update(t,bu),vu.render(yu,bu),requestAnimationFrame(Xu)}requestAnimationFrame(Xu);