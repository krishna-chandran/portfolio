...
{{< well kind="lead" prompt="Wide, 16:9: a dark operations UI with a map of runs, bag list, and a video-lidar scrubber, no customer data." caption="Eitri. Collect, store, find, clip, download." src="images/wells/well-eitri-ui.png" />}}
...
{{< well kind="inline" prompt="Inline, 4:3: a clip being cut from a lidar replay, yellow in and out points." caption="The cut. That is the feature." src="images/wells/well-lidar-clip.png" />}}
