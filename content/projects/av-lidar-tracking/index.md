...
{{< well kind="lead" prompt="Wide, 16:9: lidar boxes and camera IDs on an apron, one pedestrian and a tug, muted overlay, documentary." caption="A live list: position, velocity, still in view. The planner reads it or it is decoration." src="images/wells/well-apron-tracks.png" />}}
